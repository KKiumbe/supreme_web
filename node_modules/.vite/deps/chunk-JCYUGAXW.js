...
var Portal = React5.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React5.isValidElement(children2) ? getReactElementRef(children2) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React5.isValidElement(children2)) {
      const newProps = {
        ref: handleRef
      };
      return React5.cloneElement(children2, newProps);
    }
    return children2;
  }
...
var LazyRipple = class _LazyRipple {
  ...
  static use() {
    ...
    const [shouldMount, setShouldMount] = React9.useState(false);
    ripple.shouldMount = shouldMount;
    ripple.setShouldMount = setShouldMount;
    React9.useEffect(ripple.mountEffect, [shouldMount]);
    return ripple;
  }
  mount() {
    if (!this.mounted) {
...
var Typography = React27.forwardRef(function Typography2(inProps, ref) {
  const {
    color,
    ...themeProps
  } = useDefaultProps({
...
var FormControl = React29.forwardRef(function FormControl2(inProps, ref) {
  ...
  return (0, import_jsx_runtime18.jsx)(FormControlContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime18.jsx)(FormControlRoot, {
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ref,
...
var FilledInput = React31.forwardRef(function FilledInput2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiFilledInput"
  });
...
var OutlinedInput = React33.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  const [NotchedSlot, notchedProps] = useSlot("notchedOutline", {
    ...
    additionalProps: {
      label: label != null && label !== "" && fcs.required ? (0, import_jsx_runtime22.jsxs)(React33.Fragment, {
        children: [label, " ", "*"]
      }) : label
    }
  });
...
var Backdrop = React38.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return (0, import_jsx_runtime27.jsx)(TransitionSlot, {
    in: open,
    timeout: transitionDuration,
    ...other,
    ...transitionProps,
    children: (0, import_jsx_runtime27.jsx)(RootSlot, {
      "aria-hidden": true,
      ...rootProps,
      classes,
      ref,
...
var Menu = React42.forwardRef(function Menu2(inProps, ref) {
  ...
  let activeItemIndex = -1;
  React42.Children.map(children2, (child, index) => {
...
var NativeSelectInput = React43.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime31.jsxs)(React43.Fragment, {
    children: [(0, import_jsx_runtime31.jsx)(NativeSelectSelect, {
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref,
      ...other
    }), props.multiple ? null : (0, import_jsx_runtime31.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
var SelectInput = React44.forwardRef(function SelectInput2(props, ref) {
  ...
  const childrenArray = React44.Children.toArray(children2);
  const handleChange = (event) => {
  ...
  return (0, import_jsx_runtime32.jsxs)(React44.Fragment, {
    children: [(0, import_jsx_runtime32.jsx)(SelectSelect, {
      as: "div",
    ...
    }), (0, import_jsx_runtime32.jsx)(SelectNativeInput, {
      "aria-invalid": error,
      ...
      ...other,
      ownerState
    }), (0, import_jsx_runtime32.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime32.jsx)(Menu_default, {
      id: `menu-${name || ""}`,
...
var Select = React46.forwardRef(function Select2(inProps, ref) {
  ...
  return (0, import_jsx_runtime34.jsx)(React46.Fragment, {
...
var TextField = React47.forwardRef(function TextField2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTextField"
  });
  ...
  const InputElement = (0, import_jsx_runtime35.jsx)(InputSlot, {
  ...
  return (0, import_jsx_runtime35.jsxs)(RootSlot, {
    ...rootProps,
    children: [label != null && label !== "" && (0, import_jsx_runtime35.jsx)(InputLabelSlot, {
      htmlFor: id,
      id: inputLabelId,
      ...inputLabelProps,
      children: label
    }), select ? (0, import_jsx_runtime35.jsx)(SelectSlot, {
      "aria-describedby": helperTextId,
      id,
      ...
      ...selectProps,
      children: children2
    }) : InputElement, helperText && (0, import_jsx_runtime35.jsx)(FormHelperTextSlot, {
      id: helperTextId,
      ...formHelperTextProps,
      children: helperText
    })]
...
var Button = React50.forwardRef(function Button2(inProps, ref) {
  ...
  const startIcon = (startIconProp || loading && loadingPosition === "start") && (0, import_jsx_runtime36.jsx)(ButtonStartIcon, {
    className: classes.startIcon,
    ownerState,
    children: startIconProp || (0, import_jsx_runtime36.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  const endIcon = (endIconProp || loading && loadingPosition === "end") && (0, import_jsx_runtime36.jsx)(ButtonEndIcon, {
    className: classes.endIcon,
    ownerState,
    children: endIconProp || (0, import_jsx_runtime36.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  ...
  const loader = typeof loading === "boolean" ? (
    ...
    (0, import_jsx_runtime36.jsx)("span", {
      ...
      children: loading && (0, import_jsx_runtime36.jsx)(ButtonLoadingIndicator, {
        className: classes.loadingIndicator,
        ownerState,
  ...
  return (0, import_jsx_runtime36.jsxs)(ButtonRoot, {
    ownerState,
...
true ? Button.propTypes = {
   ...
   * @default 'primary'
   */
  color: import_prop_types41.default.oneOfType([import_prop_types41.default.oneOf(["inherit", "primary", "secondary", "success", "error", "info", "warning"]), import_prop_types41.default.string]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   * @default false
   */
  disableElevation: import_prop_types41.default.bool,
  /**
   * If `true`, the  keyboard focus ripple is disabled.
   * @default false
   */
   ...
   */
  endIcon: import_prop_types41.default.node,
  /**
   * @ignore
   */
   ...
   * @default 'center'
   */
  loadingPosition: import_prop_types41.default.oneOf(["center", "end", "start"]),
  /**
   * The size of the component.
   * `small` is equivalent to the dense button styling.
   * @default 'medium'
   ...
   */
  startIcon: import_prop_types41.default.node,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
  ...
  return (0, import_jsx_runtime37.jsx)(FormControlContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime37.jsx)(InputAdornmentRoot, {
      ...
      children: typeof children2 === "string" && !disableTypography ? (0, import_jsx_runtime37.jsx)(Typography_default, {
        color: "textSecondary",
        children: children2
      }) : (0, import_jsx_runtime37.jsxs)(React51.Fragment, {
        children: [position === "start" ? (
          /* notranslate needed while Google Translate will not fix zero-width space issue */
          _span4 || (_span4 = (0, import_jsx_runtime37.jsx)("span", {
            className: "notranslate",
            "aria-hidden": true,
            children: "​"
          }))
...
//# sourceMappingURL=chunk-JCYUGAXW.js.map
